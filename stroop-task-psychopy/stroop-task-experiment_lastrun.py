...
expName = 'stroop-task-experiment'  # from the Builder filename that created this script
expInfo = {
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\TheAn\\OneDrive\\Documents\\stroop-task-psychopy\\stroop-task-experiment_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    text_norm = visual.TextStim(win=win, name='text_norm',
        text="Instructions:\n\nIn this experiment, you will respond to the color of the text seen. \n\nPlease respond as quickly as possible.\n\nUse 'b' for blue, 'r' for red, 'y' for yellow, and 'g' for green.\n\nWhen you are ready, press [spacebar] to continue.",
        font='Arial',
    ...
    trials = data.TrialHandler(nReps=4.0, method='random', 
        ...
        trialList=data.importConditions('Stroop_fontcolor.xlsx'),
    ...
    for thisTrial in trials:
        ...
        while continueRoutine and routineTimer.getTime() < 1.2:
            ...
            if fixationCross.status == STARTED:
                ...
                if tThisFlipGlobal > fixationCross.tStartRefresh + 1.2-frameTolerance:
        ...
        Stimulus.setColor(colour, colorSpace='rgb')
        Stimulus.setText(word)
        key_resp.keys = []
        key_resp.rt = []
        _key_resp_allKeys = []
        # keep track of which components have finished
        trialComponents = [Stimulus, key_resp]
        ...
        while continueRoutine:
            ...
            if Stimulus.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > Stimulus.tStartRefresh + 3.0-frameTolerance:
                    # keep track of stop time/frame for later
            ...
            if key_resp.status == STARTED and not waitOnFlip:
                theseKeys = key_resp.getKeys(keyList=['r','b','g','y'], ignoreKeys=["escape"], waitRelease=False)
